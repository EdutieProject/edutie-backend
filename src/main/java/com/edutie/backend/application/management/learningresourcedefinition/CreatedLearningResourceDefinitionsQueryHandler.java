...
public interface CreatedLearningResourceDefinitionsQueryHandler extends UseCaseHandler<WrapperResult<List<LearningResourceDefinition>>, CreatedLearningResourceDefinitionsQuery> { }
