...
public class SegmentCreatorImplementation extends ServiceBase implements SegmentCreator {
    ...
    @Override
    public WrapperResult<Segment> createSegment(SegmentCreationDetails initializationDetails) {
        Segment segment = Segment.create(initializationDetails.educator(), initializationDetails.previousSegment());
