 ...
 */
@Slf4j
public class ExternalInfrastructureHandler<TOutputDomainEntity, TExternalServiceRequest, TExternalServiceResponse extends ExternalServiceDto<TOutputDomainEntity, TExternalServiceRequest>> {
