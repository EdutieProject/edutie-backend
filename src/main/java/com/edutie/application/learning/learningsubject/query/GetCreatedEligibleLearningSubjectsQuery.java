...
public final class GetCreatedEligibleLearningSubjectsQuery extends StudentAction<GetCreatedEligibleLearningSubjectsQuery> {
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED)
    private @NonNull LearningSubjectId learningSubjectId;

    @Override
    protected GetCreatedEligibleLearningSubjectsQuery getThis() {
        return this;
    }
