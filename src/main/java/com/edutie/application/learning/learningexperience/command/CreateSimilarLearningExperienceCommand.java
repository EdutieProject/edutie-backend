...
public final class CreateSimilarLearningExperienceCommand extends StudentAction<CreateSimilarLearningExperienceCommand> {
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED)
    private @NonNull LearningExperienceId learningExperienceId;

    @Override
    protected CreateSimilarLearningExperienceCommand getThis() {
        return this;
    }
}
