...
public final class ScaffoldLearningSubjectRequirementsCommand extends EducatorAction<ScaffoldLearningSubjectRequirementsCommand> {
    ...
    @Override
    protected ScaffoldLearningSubjectRequirementsCommand getThis() {
        return this;
    }
}
