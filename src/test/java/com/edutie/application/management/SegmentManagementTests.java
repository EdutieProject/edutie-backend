...
import com.edutie.application.management.segment.CreateSegmentCommandHandler;
import com.edutie.application.management.segment.CreatedSegmentsQueryHandler;
import com.edutie.application.management.segment.ModifySegmentCommandHandler;
import com.edutie.application.management.segment.RemoveSegmentCommandHandler;
import com.edutie.application.management.segment.commands.CreateSegmentCommand;
import com.edutie.application.management.segment.commands.ModifySegmentCommand;
import com.edutie.application.management.segment.commands.RemoveSegmentCommand;
import com.edutie.backend.application.management.segment.commands.*;
import com.edutie.application.management.segment.queries.CreatedSegmentsQuery;
...
public class SegmentManagementTests {
	...
	public void createSegmentTest() {
		...
		CreateSegmentCommand command = new CreateSegmentCommand().educatorUserId(userId).previousSegmentId(previousSegmentId).segmentName("Hello World!").segmentTheoryDescription("Desc");
	...
	public void createSegmentInBetweenTest() {
		...
		CreateSegmentCommand command1 = new CreateSegmentCommand().educatorUserId(userId).previousSegmentId(previousSegment.getId()).segmentName("Hello World!").segmentTheoryDescription("Desc");
		...
		CreateSegmentCommand command2 = new CreateSegmentCommand().educatorUserId(userId).segmentName("Segment in between").previousSegmentId(prevSegmentId).nextSegmentId(nextSegmentId);
	...
	public void getCreatedSegmentsTest() {
		CreatedSegmentsQuery query = new CreatedSegmentsQuery().educatorUserId(userId);
	...
	public void modifySegmentTest() {
		...
		ModifySegmentCommand command = new ModifySegmentCommand().educatorUserId(userId).segmentId(previousSegmentId).segmentName("Hello World");
	...
	public void removeSegmentTest() {
		...
		RemoveSegmentCommand command = new RemoveSegmentCommand().educatorUserId(userId).segmentId(previousSegmentId);
