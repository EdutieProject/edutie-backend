...
import com.edutie.application.management.course.CreateCourseCommandHandler;
import com.edutie.application.management.course.CreatedCoursesQueryHandler;
import com.edutie.application.management.course.ModifyCourseCommandHandler;
import com.edutie.application.management.course.RemoveCourseCommandHandler;
import com.edutie.application.management.course.commands.CreateCourseCommand;
import com.edutie.application.management.course.commands.ModifyCourseCommand;
import com.edutie.application.management.course.commands.RemoveCourseCommand;
import com.edutie.backend.application.management.course.commands.*;
import com.edutie.application.management.course.queries.CreatedCoursesQuery;
...
public class CourseManagementTests {
	...
	public void modifyCourseTest() {
		...
		ModifyCourseCommand command = new ModifyCourseCommand().educatorUserId(userId).courseId(course.getId()).courseName("Altered name").accessibility(true);
	...
	public void getCreatedCoursesTest() {
		...
		CreatedCoursesQuery query = new CreatedCoursesQuery().educatorUserId(userId);
	...
	public void removeCourseTest() {
		...
		RemoveCourseCommand command = new RemoveCourseCommand().educatorUserId(userId).courseId(course.getId());
