...
public class SkillTests {
    ...
    public void skillIndicatorReassignmentTest() {
        ...
        assertEquals(1, skill.getTraitIndicator(Intelligence.VISUAL, IntelligenceIndicator.class).get().getValue());

        skill.assignTraitIndicator(Intelligence.VISUAL, 2, IntelligenceIndicator.class);

        assertEquals(2, skill.getTraitIndicator(Intelligence.VISUAL, IntelligenceIndicator.class).get().getValue());
    }
